...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument(
        "--config-file", default="/workspace/Pointcept/configs/navarra/pretrain-sonata-v1m2-0-outdoor-navarra-md.py", metavar="FILE", help="path to config file"
    )
    # "/home/Pointcept/configs/navarra/navarra_test.py" #  semseg-sonata-v1m1-0a-navarra-lin.py
    # "/home/Pointcept/configs/navarra/pretrain-sonata-v1m1-0-base-navarra.py"   pretrain-sonata-v1m1-0-outdoor-navarra.py
